/**
 * Complete LGA list for all 36 Nigerian states + FCT.
 * Keyed by the state ISO code used by country-state-city (e.g. "LA" for Lagos).
 */
export const NIGERIA_LGAS: Record<string, string[]> = {
  ...
  KW: [ // Kwara
    "Asa","Baruten","Edu","Ekiti (Kwara)","Ifelodun","Ilorin East","Ilorin South",
