...
import { Search, Calendar, Clock, BookOpen, Mail } from "lucide-react"
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6">
              ...
              <p className="text-gray-500 text-xs mb-4 leading-relaxed">
                Get the latest articles and IDD care resources — no spam.
              </p>
              <div className="space-y-2">
                <Input type="email" placeholder="your@email.com" className="text-sm h-9 border-gray-200 focus:border-primary" />
                <Button className="w-full h-9 text-sm bg-primary hover:bg-primary text-white">Subscribe</Button>
              </div>
