...
import { Send, Bot, User, Loader2, RefreshCw, MessageCircle, X, Minimize2 } from "lucide-react"
...
export default function FloatingChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Hello! I'm your Nexora Assistant. I'm here to help answer questions about intellectual and developmental disabilities, care strategies, and support resources. How can I assist you today?",
      timestamp: new Date(),
    },
  ])
  ...
  const handleSendMessage = async (messageText?: string) => {
    ...
    try {
      // Prepare conversation history (excluding the initial greeting for API)
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className={cn(
        "bg-white rounded-lg shadow-2xl border transition-all duration-200",
        ...
        {isMinimized ? (
          ...
          <div className="flex items-center justify-between p-4 h-full">
            ...
            <div className="flex items-center gap-1">
              <Button variant="ghost" size="sm" onClick={expandChat}>
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-between p-4 border-b bg-gray-50 rounded-t-lg">
              ...
              <div className="flex items-center gap-1">
                ...
                <Button variant="ghost" size="sm" onClick={minimizeChat} className="text-gray-500 hover:text-gray-700">
                  <Minimize2 className="h-4 w-4" />
                </Button>
                <Button variant="ghost" size="sm" onClick={closeChat} className="text-gray-500 hover:text-gray-700">
                  <X className="h-4 w-4" />
                </Button>
              </div>
            </div>
